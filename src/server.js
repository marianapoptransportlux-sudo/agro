...
app.get("/api/receipts", requireRoles(["operator", "manager", "accountant", "accountant-sef", "admin", "control"]), listReceiptsHandler);
...
app.get("/api/processings", requireRoles(["operator", "manager", "accountant", "accountant-sef", "admin", "control"]), listProcessingsHandler);
...
app.get("/api/stocks", requireRoles(["operator", "manager", "accountant", "accountant-sef", "admin", "control"]), getStockSummaryHandler);

app.get("/api/transactions", requireRoles(["manager", "accountant", "accountant-sef", "admin", "control"]), listTransactionsHandler);

app.post("/api/transactions", requireRoles(["manager", "accountant", "accountant-sef", "admin"]), createTransactionHandler);

app.patch("/api/transactions/:id", requireRoles(["manager", "accountant", "accountant-sef", "admin"]), async (req, res) => {
  return updateTransactionHandler(req, res, req.params.id);
});

app.get("/api/partner-advances", requireRoles(["manager", "accountant", "accountant-sef", "admin", "control"]), listPartnerAdvancesHandler);

app.post("/api/transactions/apply-advance", requireRoles(["manager", "accountant", "accountant-sef", "admin"]), applyAdvanceHandler);

app.get("/api/deliveries", requireRoles(["operator", "manager", "accountant", "accountant-sef", "admin", "control"]), listDeliveriesHandler);
...
app.post("/api/deliveries/:id/confirm", requireRoles(["operator", "manager", "admin"]), async (req, res) => {
  return transitionDeliveryHandler("confirm")(req, res, req.params.id);
});

app.post("/api/deliveries/:id/deliver", requireRoles(["operator", "manager", "admin"]), async (req, res) => {
  return transitionDeliveryHandler("deliver")(req, res, req.params.id);
});

app.post("/api/deliveries/:id/close", requireRoles(["manager", "admin"]), async (req, res) => {
  return transitionDeliveryHandler("close")(req, res, req.params.id);
});

app.post("/api/deliveries/:id/cancel", requireRoles(["manager", "admin"]), async (req, res) => {
  return transitionDeliveryHandler("cancel")(req, res, req.params.id);
});

app.post("/api/deliveries/:id/reopen", requireRoles(["manager", "admin"]), async (req, res) => {
  return transitionDeliveryHandler("reopen")(req, res, req.params.id);
});

app.get("/api/complaints", requireRoles(["operator", "manager", "accountant", "accountant-sef", "admin", "control"]), listComplaintsHandler);

app.post("/api/complaints", requireRoles(["operator", "manager", "accountant", "accountant-sef", "admin"]), createComplaintHandler);

app.patch("/api/complaints/:id", requireRoles(["manager", "accountant", "accountant-sef", "admin"]), async (req, res) => {
  return updateComplaintHandler(req, res, req.params.id);
});

app.get("/api/reports/daily", requireRoles(["manager", "accountant", "accountant-sef", "admin", "control"]), getDailyReportHandler);
